...
from agent.bisim_ours_agent import BisimOursAgent
import os
np.float = float
np.int = int
...
def parse_args():
    ...
    # train
    parser.add_argument('--agent', default='BisimOursAgent', type=str, choices=['baseline', 'bisim','BisimOursAgent'])
...
def make_agent(obs_shape, action_shape, args, device):
    ...
    elif args.agent == 'BisimOursAgent':
...
def main():
    ...
    video = VideoRecorder(
        video_dir if args.save_video else None,
        resource_files=args.resource_files
    )
